...
data SodaFunc datatype where
    ...
    Between                  :: (SodaExpr m, SodaExpr n, SodaExpr o, SodaType a) => m a -> n a -> o a -> SodaFunc Checkbox
...
data SodaAgg datatype where
    Avg   :: SodaType a => Column a -> SodaAgg SodaNum
    Count :: SodaType a => Column a -> SodaAgg SodaNum
    Max   :: (SodaType a) => Column a -> SodaAgg a
    Min   :: (SodaType a) => Column a -> SodaAgg a
...
data SodaOp datatype where
    ...
    Less            :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b-> SodaOp Checkbox
    LessOrEquals    :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b-> SodaOp Checkbox
    Greater         :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b-> SodaOp Checkbox
    GreaterOrEquals :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b-> SodaOp Checkbox
    Add             :: (SodaExpr m, SodaExpr n, SodaType numA, SodaType numB) => m numA -> n numB -> SodaOp numB
    -- Might have to add another similar operator with different characters for final type going the other way.
    Subtract        :: (SodaExpr m, SodaExpr n, SodaType numA, SodaType numB) => m numA -> n numB -> SodaOp numB
    Multiply        :: (SodaExpr m, SodaExpr n, SodaType numA, SodaType numB, SodaType numC) => m numA -> n numB -> SodaOp numC
    Divide          :: (SodaExpr m, SodaExpr n, SodaType numA, SodaType numB, SodaType numC) => m numA -> n numB -> SodaOp numC
...
infixr 4 $==
($==) :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b -> SodaOp Checkbox
($==) = Equals
...
infixl 6 $+
($+) :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b) => m a -> n b -> SodaOp b
($+) = Add
...
infixl 7 $*
($*) :: (SodaExpr m, SodaExpr n, SodaType a, SodaType b, SodaType c) => m a -> n b -> SodaOp c
($*) = Multiply
